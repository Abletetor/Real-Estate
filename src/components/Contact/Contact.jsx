...
const formID = import.meta.env.VITE_APP_FORM_ID;
            ...
            <form onSubmit={ onSubmit } className="max-w-2xl mx-auto text-gray-800 pt-8">
               <div className="flex flex-wrap">
                  <div className="w-full md:w-1/2 text-left">
                     Your Name
                     <input type="text" name="name" id="Name" placeholder="Your Name" required className="w-full border border-gray-300 rounded py-3 px-4 mt-2" />
                  </div>
                  <div className="w-full md:w-1/2 text-left md:pl-4 mt-2">
                     Your Email
                     <input type="email" name="Email" id="Email" placeholder="Your Email" required className="w-full border border-gray-300 rounded py-3 px-4 mt-2" />
                  </div>
               </div>
               ...
               <button className="bg-blue-600 text-white py-2 px-12 mb-10 rounded cursor-pointer hover:bg-blue-700 transition">{ result ? result : 'Send Message' }</button>
            </form>
         </motion.div>
      </section>
   );
